  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="container max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <a href="https://deeptrust-sandy.vercel.app/" className="bg-primary text-primary-foreground px-5 py-2 font-display text-xs tracking-wider hover:opacity-90 transition-all duration-150 uppercase rounded-lg inline-block">
          Get Started
        </a>
      </div>
    </nav>
