    ...
    >
      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-calligraphy text-4xl md:text-6xl tracking-tight" style={{ color: "hsl(0 0% 95%)" }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f, i) => (
            <motion.div
              ...
              style={{
                background: "linear-gradient(135deg, hsl(240 18% 12%) 0%, hsl(240 15% 9%) 100%)",
              ...
              whileHover={{
                scale: 1.02,
                boxShadow: "0 8px 40px -4px hsl(190 80% 50% / 0.2), 0 0 25px hsl(190 80% 50% / 0.1)",
